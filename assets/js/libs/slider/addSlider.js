  ...
  Object.defineProperty(this, "value", {
    ...
    set: function(newVal){
      ...
      if(!this._settings.range){
        ...
        if(this._settings.value < 10000000){
          let visibleVal = (this._settings.value/100000).toPrecision(3);
          this._elements.find(".addui-slider-value span").html("INR "+ toFunc(this._settings.formatter).call(this, visibleVal) + " L Monthly Turnover");
        } else {
          let visibleVal = (this._settings.value/10000000).toPrecision(2);
          this._elements.find(".addui-slider-value span").html("INR "+ toFunc(this._settings.formatter).call(this, visibleVal) + " Cr Monthly Turnover");
        }
          sliderValue = this._settings.value;
      } else {
